...
const translations = {
  zh: {
    ...
    welcome: "欢迎来到社区",
    desc1: "公告:<br>DC频道更新<br>频道更新<br>感谢你的支持 ❤️",
  ...
  en: {
    ...
    desc1: "Announcement:<br><br><br>Thank you for your support ❤️",
  ...
  es: {
    ...
    desc1: "El sistema de inicio de sesión ha sido eliminado.<br>Puede unirse directamente a nuestra comunidad y servidor.<br><br>¡Gracias por su apoyo ❤️",
